...
?>
					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> Edit Invoice </h3>
							</div>
							<div class="box-content nopadding">
								<form action="edit_submit_payments.php" method="POST" class='form-horizontal form-bordered'>
...
?>" class="uneditable-input"  readonly/>
										...
										<div class="controls">
											<input type="text" name="invoice" value="<?php
    echo $memid;
?>" class="uneditable-input"  readonly/>
										</div>
									</div>
...
<div class="control-group">
    ...
    echo $name;
?>" placeholder="Member Name" maxlength="30" readonly/>
