                    ...
                    <div class="span12">
                        <div class="box box-bordered box-color">
                            ...
                            <div class="box-content nopadding">
                                <form action="edit_mem_submit.php" method="POST" class='form-horizontal form-bordered'>
                                    <?php
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><span id="sprytextfield1">
										  <input type="text" name="p_name" id="textfield3" class="input-xlarge"
                                                 data-rule-required="true" data-rule-minlength="4" value='<?php
                                          echo $name;
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <input type="text" name="email" id="emailfield" class="input-xlarge"
                                                   value='<?php
                                                   echo $email;
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><span id="sprytextfield2">
										  <input type="text" name="age" id="textfield4" class="input-xlarge"
                                                 data-rule-required="true" data-rule-minlength="1" placeholder="Age"
                                                 value='<?php
                                                 echo $age;
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="add" id="textfield5" class="input-xlarge"
                                                   data-rule-required="true" data-rule-minlength="6" value='<?php
                                            echo $address;
                                            ?>' placeholder="Address">
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls"><span id="sprytextfield4">
										  <input type="text" name="contact" id="textfield6" class="input-xlarge"
                                                 data-rule-required="true" data-rule-minlength="10"
                                                 placeholder="Mobile / Phone" value='<?php
                                          echo $contact;
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="height" id="textfield" class="input-large"
                                                   data-rule-required="true" data-rule-minlength="1"
                                                   placeholder="Height" onKeyPress="return checkIt(event)" value='<?php
                                            echo $height;
                                            ?>' maxlength="3"> (In Feet)
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="weight" id="textfield" class="input-large"
                                                   data-rule-required="true" data-rule-minlength="1"
                                                   placeholder="Weight" onKeyPress="return checkIt(event)" value='<?php
                                            echo $weight;
                                            ?>' maxlength="3"> (In Kgs)
                                        </div>
                                    </div>
