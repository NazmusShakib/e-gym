                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="add" id="textfield5" class="input-xlarge"
                                               data-rule-required="true" data-rule-minlength="6" placeholder="Address">
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls"><span id="sprytextfield4">
										  <input type="text" name="contact" id="textfield6" class="input-xlarge"
                                                 ...
                                                 placeholder="Mobile / Phone" onKeyPress="return checkIt(event)"
                                                 maxlength="10">
									    <span class="textfieldRequiredMsg">A value is required.</span></span></div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="height" id="textfield" class="input-large"
                                               data-rule-required="true" data-rule-minlength="1" placeholder="Height"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="weight" id="textfield" class="input-large"
                                               data-rule-required="true" data-rule-minlength="1" placeholder="Weight"
                                               maxlength="10"> (In Kgs)
                                    </div>
                                </div>
