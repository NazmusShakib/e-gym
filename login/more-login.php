...
<body class='login'>
<div class="wrapper">
    <h1><a href="index.html"><img src="icon.png" alt="" class='retina-ready' width="300" height="300"><br>
        </a></h1>
    ...
    <div class="login-body">
        ...
        <form action="secure_login.php" method='post' class='form-horizontal form-validate' id="bb">
            <div class="control-group">
                <div class="controls">
                    <input type="text" placeholder="User ID" class="input-large" name="user_id_auth" id="textfield"
                           data-rule-minlength="6" data-rule-required="true"></div>
            </div>
            <p>
            <div class="control-group">

                <div class="controls">
                    <input type="password" name="pass_key" id="pwfield" class="input-large" data-rule-required="true"
                           data-rule-minlength="6" placeholder="Passcode">
                </div>
            </div>
